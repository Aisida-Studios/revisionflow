...
export const addMistake = async (uid, data) => {
  ...
  // Same principle as the saveNote fix above — no content-length check here meant a one-word
  // "description" earned the same +10 XP as a real, reflective mistake entry.
